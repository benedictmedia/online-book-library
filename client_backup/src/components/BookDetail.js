...
function BookDetail({ backendUrl }) {
  ...
  // These logs will show what 'user' and 'book' values are right before rendering
  console.log('BookDetail Render - Current User:', user);
  console.log('BookDetail Render - Book Data:', book);
  if (book) {
    console.log('BookDetail Render - book.file_path:', book.file_path);
    console.log('BookDetail Render - is user truthy?', !!user); // Check if user object exists (truthy)
    console.log('BookDetail Render - is book.file_path truthy?', !!book.file_path); // Check if file_path exists (truthy)
    console.log('BookDetail Render - Download button condition (user && book.file_path):', !!user && !!book.file_path);
  }
  // --------------------------------
